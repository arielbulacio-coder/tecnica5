    ...
    return (
        <div className="drawing-container">
                ...
                <section className="drawing-card">
                    ...
                    <div className="isometric-demo">
                        <svg viewBox="0 0 100 80" width="200" style={{ margin: '1rem auto', display: 'block' }}>
                            {/* Ejes Isométricos */}
                            <line x1="50" y1="40" x2="50" y2="10" stroke="#555" strokeDasharray="2,2" />
                            <line x1="50" y1="40" x2="80" y2="57.3" stroke="#555" strokeDasharray="2,2" />
                            <line x1="50" y1="40" x2="20" y2="57.3" stroke="#555" strokeDasharray="2,2" />
            ...
            <section className="practical-exercise">
                <h3>Ejercicio: Trazado Isométrico</h3>
                <ol>
                    <li>Afilá bien el lápiz HB para el trazado principal y el 2H para auxiliar.</li>
                    <li>Utilizá la escuadra de 30°/60°.</li>
                    <li>Dibujá un cubo de 50mm de lado en perspectiva isométrica sin reducción.</li>
                </ol>
            </section>
        </div>
    );
