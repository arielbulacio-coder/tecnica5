            ...
            <div className="drawing-grid">
                ...
                <section className="drawing-card">
                    ...
                    <div className="info-box">
                        <strong>Márgenes:</strong> Izquierdo 25mm (para encuadernación), resto 10mm (excepto en A4 que suele ser 10mm arriba, abajo y derecha).
                    </div>
                </section>
                ...
                <section className="drawing-card">
                    ...
                    <table className="iram-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><strong>F</strong> (Trazo y punto)</td>
                                <td>─ ∙ ─ ∙ ─</td>
                                <td>Ejes de simetría y centros.</td>
                            </tr>
                        </tbody>
                    </table>
                </section>
                ...
                <section className="drawing-card">
                    ...
                    <ul>
                        ...
                        <li><strong>Ampliación:</strong> 2:1, 5:1, 10:1</li>
                        <li><strong>Reducción:</strong> 1:2, 1:5, 1:10, 1:20, 1:50...</li>
                    </ul>
                </section>
            </div>

            <section className="practical-exercise">
                <h3>Ejercicio Práctico #1</h3>
                <p>Dibujar en una lámina A4 el recuadro y rótulo estándar según IRAM 4504, utilizando líneas tipo A para el recuadro y tipo B para las divisiones del rótulo.</p>
            </section>
        </div>
    );
};
